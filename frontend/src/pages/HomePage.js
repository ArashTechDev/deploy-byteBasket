    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="bg-gray-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-8">{t('appName', 'Bytebasket')}</h1>
              <h2 className="text-3xl mb-12 leading-relaxed">
                {t('taglineLine1', 'Nourishing Communities,')}<br />
                {t('taglineLine2', 'One Byte at a Time!')}
              </h2>
      ...
      <section className="bg-gray-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-16">{t('waysToGive', 'Ways to give')}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-teal-200 rounded-3xl p-8 text-center text-gray-800">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('inventoryTitle', 'Inventory')}</h3>
              <p className="text-gray-700 leading-relaxed">
                {t('inventoryDesc', 'Effortlessly monitor and contribute to our inventory online, ensuring transparency and convenience in accessing and donating items.')}
              </p>
            </div>
            ...
            <div className="bg-teal-200 rounded-3xl p-8 text-center text-gray-800">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('giveTitle', 'Give')}</h3>
              <p className="text-gray-700 leading-relaxed">
                {t('giveDesc', 'Contribute to our mission of alleviating hunger by supporting us through monetary donations and food contributions.')}
              </p>
            </div>
            ...
            <div className="bg-teal-200 rounded-3xl p-8 text-center text-gray-800">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('volunteerTitle', 'Volunteer')}</h3>
              <p className="text-gray-700 leading-relaxed">
                {t('volunteerDesc', 'Join us in the fight against hunger by volunteering at our food bank and making a meaningful difference in the lives of those in need.')}
              </p>
            </div>
          </div>
        </div>
